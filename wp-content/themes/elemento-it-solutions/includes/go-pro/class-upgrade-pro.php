	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Elemento_IT_Solutions_Customize_Section_Pro(
				...
				array(
					...
					'pro_text'    => esc_html__( 'GO PRO', 'elemento-it-solutions' ),
					'pro_url'     => 'https://www.wpelemento.com/elementor/it-solutions-wordpress-theme/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Elemento_IT_Solutions_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/theme-documentation/elemento-it-solutions/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Elemento_IT_Solutions_Customize_Section_Pro(
				...
				array(
					'title'       => esc_html__( 'Demo link', 'elemento-it-solutions' ),
					'pro_text'    => esc_html__( 'Demo', 'elemento-it-solutions' ),
					'pro_url'     => 'https://www.wpelemento.com/demo/elemento-it-solutions/',
					'priority'    => 5,
				)
			)
		);
