...
if (!function_exists('elemento_it_solutions_after_setup_theme')) {
	...
	function elemento_it_solutions_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'elemento-it-solutions') {
			wp_redirect(admin_url('themes.php?page=elemento_it_solutions_about'));
		}
...
if (!function_exists('elemento_it_solutions_loop_columns')) {
	function elemento_it_solutions_loop_columns() {
		return get_theme_mod( 'elemento_it_solutions_products_per_row', '3' ); 
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'elemento_it_solutions_products_per_page' );
function elemento_it_solutions_products_per_page( $cols ) {
  	return  get_theme_mod( 'elemento_it_solutions_products_per_page',9);
}
